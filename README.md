...
## 🛠️ Sunduğum Hizmetler

- 🖥️ **Hosting** — 10+ yıldır aktif reseller bayi hosting, cPanel altyapısı ile müşterilere özel hosting çözümleri
- 🎨 **Web Tasarım** — WordPress & Safir Tema ile kurumsal web sitesi tasarımı · [Portfolyo →](https://sayfatasarim.com/#!/portfolio)
- 🌍 **Domain** — Satılık domain hizmeti, alan adı danışmanlığı
- 📈 **SEO & Google Ads** — Arama motoru optimizasyonu ve reklam yönetimi
- 🏢 **Dijital Ajans** — KOBİ'lere dijital pazarlama danışmanlığı
...
- 🏛️ Sakarya Üniversitesi — Bilgisayar Programcılığı
